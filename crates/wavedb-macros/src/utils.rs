...
pub fn collect_derived_traits(attrs: &[syn::Attribute]) -> std::collections::HashSet<String> {
...
pub fn parse_trailing_version(name: &str, span: proc_macro2::Span) -> syn::Result<u8> {
